  ...
  return (
    <ContentSectionContainer>
      <div className="flex flex-col gap-10 self-center">
        ...
        <ul className="grid grid-cols-2 grid-rows-2 w-full h-[50vh] md:grid-cols-4 md:grid-rows-1 gap-6 md:gap-20 text-sm md:text-md pt-4 font-semibold uppercase tracking-widest">
          <li>

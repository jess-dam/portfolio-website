    ...
    <SectionContainer id={SECTION_REFS.LANDING} bgColor="primary" textColor="white">
      ...
      >
        <div className="relative flex flex-col items-center overflow-hidden w-[250px] md:w-[700px] pb-10">
          <h2 className='text-accent text-center pb-10'>Hello! my name is</h2>
            <motion.h1
            ...
            <img src='/assets/images/doodles/cat_on_laptop.svg' className='absolute z-20 mb-7 md:mb-12 ml-10 right-[200px] top-[30px] w-[100px] md:w-[300px]' width={300}/>
          </div>
          <div className='flex p-8 px-10 justify-between w-[250px] md:w-[700px]'>
